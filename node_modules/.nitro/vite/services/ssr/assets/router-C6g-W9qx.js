import { i as useAuth, r as AuthProvider, t as AuthModal } from "./AuthModal-C56nx3nQ.js";
import { a as getFullCategories } from "./catalog-C46Q34UE.js";
import { t as Route$3 } from "./mesajlar-CczOc8oQ.js";
import { t as Route$4 } from "./kategori._category-BmbIJCrn.js";
import { t as Route$5 } from "./urun._productId-nl4lRe96.js";
import { t as Route$6 } from "./katalog._category._subcategory-BOnsnUT0.js";
...
//#endregion
//#region src/assets/almir-logo.png
				...
				children: [
					...
					/* @__PURE__ */ jsxs("nav", {
						...
						children: [
							...
							categoryList.map((cat) => /* @__PURE__ */ jsx(Link, {
							...
							isAdmin && /* @__PURE__ */ jsxs(Link, {
								...
								children: [/* @__PURE__ */ jsx(Shield, { className: "size-4" }), /* @__PURE__ */ jsx("span", { children: "Yönetim" })]
							})
						]
					}),
					/* @__PURE__ */ jsxs("div", {
				...
				children: /* @__PURE__ */ jsxs("nav", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs(Link, {
							...
							children: [/* @__PURE__ */ jsx(MessageSquare, { className: "size-4 text-primary" }), /* @__PURE__ */ jsx("span", { children: "Soru Sor / Sohbet" })]
						}),
						isAdmin && /* @__PURE__ */ jsxs(Link, {
							to: "/yonetim",
							onClick: () => setMobileMenuOpen(false),
							...
							children: [/* @__PURE__ */ jsx(Shield, { className: "size-4" }), /* @__PURE__ */ jsx("span", { children: "Yönetim Paneli" })]
						})
					]
				})
			}),
...
function RootComponent() {
	...
	return /* @__PURE__ */ jsx(QueryClientProvider, {
		client: queryClient,
		children: /* @__PURE__ */ jsx(AuthProvider, { children: /* @__PURE__ */ jsxs("div", {
...
var $$splitComponentImporter$1 = () => import("./routes-VuZrQBk3.js");
...
//#endregion
//#region src/routes/yonetim.tsx
var $$splitComponentImporter = () => import("./yonetim-DRzWTSxM.js");
...
var rootRouteChildren = {
	...
	UrunProductIdRoute: Route$5.update({
		id: "/urun/$productId",
		path: "/urun/$productId",
		getParentRoute: () => Route$2
	}),
	KatalogCategorySubcategoryRoute: Route$6.update({
