import { t as supabase } from "./client-DxLTTzyN.js";
import { i as useAuth, t as AuthModal } from "./AuthModal-C56nx3nQ.js";
import { t as Route } from "./urun._productId-nl4lRe96.js";
import { n as formatPrice } from "./format-zQdBECWS.js";
import { t as notifyAdminsOnNewQuestion } from "./notifications-D42LmJ8Y.js";
import { r as insertMessage } from "./messages-tFNJ6S8J.js";
import { useState } from "react";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { CheckCircle2, ChevronDown, ChevronLeft, ChevronRight, ChevronUp, Factory, Maximize2, MessageSquare, Ruler, ShieldCheck, Sparkles, Truck, X } from "lucide-react";
import { toast } from "sonner";
//#region src/routes/urun.$productId.tsx?tsr-split=component
function ProductPage() {
	...
	if (isLoading) return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", { className: "h-6 w-48 animate-pulse rounded bg-secondary" }), /* @__PURE__ */ jsxs("div", {
			className: "mt-8 grid gap-10 lg:grid-cols-2",
			children: [/* @__PURE__ */ jsx("div", { className: "aspect-[4/5] animate-pulse rounded-2xl bg-secondary" }), /* @__PURE__ */ jsxs("div", {
				className: "space-y-4",
				children: [/* @__PURE__ */ jsx("div", { className: "h-10 w-3/4 animate-pulse rounded bg-secondary" }), /* @__PURE__ */ jsx("div", { className: "h-20 animate-pulse rounded bg-secondary" })]
			})]
		})]
	});
		...
		children: [
			/* @__PURE__ */ jsxs("nav", {
				...
				children: [
					...
					cat && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Link, {
						to: "/kategori/$category",
						params: { category: cat.slug },
						className: "hover:text-foreground",
						children: cat.name
					}), /* @__PURE__ */ jsx("span", { children: "/" })] }),
					cat && sub && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Link, {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
					...
					Array.isArray(data.materials) && data.materials.length > 0 && /* @__PURE__ */ jsxs("div", {
						className: "mt-6 border-t border-border pt-5",
						children: [/* @__PURE__ */ jsxs("p", {
							className: "flex items-center gap-1.5 text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground",
							children: [/* @__PURE__ */ jsx(Sparkles, { className: "size-3.5 text-primary" }), /* @__PURE__ */ jsx("span", { children: "Kullanılan Malzemeler" })]
						}), /* @__PURE__ */ jsx("div", {
							className: "mt-3 flex flex-wrap gap-2",
							children: data.materials.map((m) => /* @__PURE__ */ jsx("span", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("p", {
							className: "flex items-center gap-1.5 text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground",
							children: [/* @__PURE__ */ jsx(Ruler, { className: "size-3.5 text-primary" }), /* @__PURE__ */ jsx("span", { children: "Standart Ölçüler" })]
						}), /* @__PURE__ */ jsxs("div", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("button", {
							...
							children: [/* @__PURE__ */ jsx("span", { children: showMore ? "Daha Az Teknik Detay" : "Daha Fazla Bilgi ve Teknik Detaylar" }), showMore ? /* @__PURE__ */ jsx(ChevronUp, { className: "size-4" }) : /* @__PURE__ */ jsx(ChevronDown, { className: "size-4" })]
							...
							children: [
								/* @__PURE__ */ jsx(DetailRow, {
									icon: /* @__PURE__ */ jsx(ShieldCheck, { className: "size-4 text-primary" }),
									label: "Garanti Süresi",
									value: data.warranty
								}),
								/* @__PURE__ */ jsx(DetailRow, {
									icon: /* @__PURE__ */ jsx(Truck, { className: "size-4 text-primary" }),
									label: "Teslimat Süresi",
									value: data.delivery_time
								}),
								/* @__PURE__ */ jsx(DetailRow, {
									icon: /* @__PURE__ */ jsx(Factory, { className: "size-4 text-primary" }),
									label: "Üretim Yeri",
								...
								Object.entries(extras).map(([k, v]) => /* @__PURE__ */ jsx(DetailRow, {
									label: k,
									value: String(v)
								}, k))
							]
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(MessageSquare, { className: "size-5 text-primary" }), /* @__PURE__ */ jsx("h2", {
							...
							user ? /* @__PURE__ */ jsx("div", {
								...
								children: questionSent ? /* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "size-4" }), /* @__PURE__ */ jsx("span", { children: "Sorunuz başarıyla iletildi!" })]
										}),
										/* @__PURE__ */ jsx("p", {
											className: "mt-1 text-xs text-muted-foreground",
								...
								children: [/* @__PURE__ */ jsx("p", {
									...
									children: /* @__PURE__ */ jsx("span", { children: "Giriş Yap ve Soru Sor" })
								})]
							})
						]
					})
